...
export class DialogNamePrompttComponents {
  ...
  constructor(protected ref: NbDialogRef<DialogNamePrompttComponents>,private service: SmartTableData,private user: UsersService,private toastrService: NbToastrService) {}
