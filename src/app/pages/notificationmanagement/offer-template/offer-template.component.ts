...
import { DialogNamePrompttComponentss } from './dialog-name-prompt/dialog-name-prompt.component';
// import { DialogNamePromptComponent } from './dialog-name-prompt/dialog-name-prompt.component';
// import { DialogNamePromptComponent } from '../../modal-overlays/dialog/dialog-name-prompt/dialog-name-prompt.component';


@Component({
  selector: 'ngx-offer-template',
  styleUrls: ['./offer-template.component.scss'],
  templateUrl: './offer-template.component.html',
})
export class OfferTempComponent {
  [x: string]: any;
...
open3(){
  this.dialogService.open(DialogNamePrompttComponentss)
  // this.onSubmit(body);
