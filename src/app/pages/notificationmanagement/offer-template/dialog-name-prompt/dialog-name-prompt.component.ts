...
export class DialogNamePrompttComponentss {
  ...
  constructor(protected ref: NbDialogRef<DialogNamePrompttComponentss>,private service: SmartTableData,private user: UsersService,private toastrService: NbToastrService) {}
  ...
  getOffer() {
    this.user.getOffer().subscribe((result) => {
      this.offerList = result["response"];
      // this.customerList.concat(this.list);
